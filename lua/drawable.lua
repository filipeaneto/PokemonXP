...
Type(Drawable, function(drawable, loveDrawable)
    
    drawable.drwImage = loveDrawable -- userdata

end)

-- utiliza os mesmos argumentos de love.graphics.draw
function Drawable:draw(...)
    love.graphics.draw(self.drwImage, ...)
end
